...
class BlackoutTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function blackoutProvider()
    {
        return [
            ['bazinga', 'bazinga'],
            ['I am not crazy, my mother ... ummm ... wait ... what were we talking about again ?', 'I am not crazy, my mother had me tested.'],
            ...
            [
                'Scissors cuts paper, paper covers rock, rock crushes lizard, lizard poisons Spock, Spock smashes scissors, scissors decapitates ... ummm ... wait ... what were we talking about again ?',
                'Scissors cuts paper, paper covers rock, rock crushes lizard, lizard poisons Spock, Spock smashes scissors, scissors decapitates lizard, lizard eats paper, paper disproves Spock, Spock vaporizes rock, and as it always has, rock crushes scissors.'
            ],
            [
                'En hiver, cette place est suffisamment proche du radiateur, du coup elle est bien chaude sans causer pour autant un phénomène de transpiration. Et en été c\'est pratique car elle est dans l\'axe d\'une petite brise provoquée par l\'ouverture de nos ... ummm ... wait ... what were we talking about again ?',
